                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <form action="{{ url('restaurant/slides') }}" method="post" enctype="multipart/form-data">
                                    @method(PUT)
                                    @csrf
                                ...
                                <select name="category" class="form-control">
                                    ...
                                    <input type="file" name="img" class="mb-2 form-control" placeholder="موضوع جدید">
                            ...
                            <p class="dropdown-divider"></p>
								<table class="table table-bordered table table-hover">
									...
									<tr>
										...
										<td><a href="{{ url('restaurant/slides/delete/'.$slide->id) }}">حذف</a></td>
									</tr>
									@empty
